...
import {europaLeagueCompetitions, europaConferenceMatches} from './calendarEuropaConferenceTips'
...
export async function getCalendarData() {
  ...
  const matches = mergeWithCms(
    [...starterMatches, ...championsLeagueMatches, ...europaConferenceMatches],
    cmsMatches,
    matchKey,
